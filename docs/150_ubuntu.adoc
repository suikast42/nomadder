...
===== Power settings
Ubuntu desktop on esxi disablkes the gnome desktop after serval time
for that install
...
Then install the extension Unblank lock screen and disable everything in dconf-editor under org/gnome/settings-daemon/plugins/power
image::ubuntu_powersetting_on_esxi_1.png[]

Disable power setting
image::ubuntu_powersetting_on_esxi_2.png[]
