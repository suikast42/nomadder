  ...
  group "keycloak-ingress" {
    ...
    task "forwardauth" {
      ...
      env {
        ...
        #        CLIENT_ID     = "ingress"
        #        CLIENT_SECRET = "TbvjwR0rYUOtgGNuHRoyXH9Ghb0Od1Or"
        #        LOG_LEVEL     = "debug"
        #        COOKIE_DOMAIN = "cloud.private"

        SECRET                       = "9e7d7b0776f032e3a1996272c2fe22d2"
        PROVIDERS_OIDC_CLIENT_ID     = "ingress"
        PROVIDERS_OIDC_CLIENT_SECRET = "XMgvP4XBduDKQJTNJGyQ6dg1uTXTscmH"
        PROVIDERS_OIDC_ISSUER_URL    = "https://security.cloud.private/realms/nomadder"
        LOG_LEVEL                    = "debug"
        DEFAULT_PROVIDER             = "oidc"
        AUTH_HOST                    = "forwardauth.service.consul:${NOMAD_HOST_PORT_auth}"
        COOKIE_DOMAIN                = "cloud.private"
